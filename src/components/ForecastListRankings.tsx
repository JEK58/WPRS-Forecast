...
export function ListRankings({ data }: { data: Forecast["confirmed"] }) {
    ...
    return data?.WPRS.map((el, i) => {
      return (
        <TableRow key={i}>
          ...
          <TableCell className="text-slate-400">{el.Ta2}</TableCell>
          <TableCell className="text-slate-400">{el.Ta1}</TableCell>
        </TableRow>
      );
    });
  };
  ...
  return (
    <div className="collapse collapse-arrow mt-4 border border-slate-300">
      <input type="checkbox" />
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-slate-400">2 Tasks</TableHead>
                <TableHead className="text-slate-400">1 Task</TableHead>
              </TableRow>
            </TableHeader>
